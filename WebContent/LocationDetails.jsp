...
<div id="detailsAndActions">
	...
	<div class="vn_actionlistdiv yui-reset yui-base">
		<div class="vn_actionlistcolumn">
			<div class="vn_actionbuttondiv">
				<div class="title">
				<a title="Edit Location" href="/Edit_bla.jsp">
				...
				<div class="vn_actionbuttondiv">
				<div class="title">
				<a title="Delete Location" href="/Delete_bla.jsp">
	...
	<% String locationId = request.getParameter("locId");
	   Location location = LocationDao.getInstance().getLocationById(locationId);
	%>
